...
export function getInitialBreakpointsMessage(structuredCode: StructuredCode[]): ChatCompletionUserMessageParam {
  return {
    role: 'user',
    content: [
...
export function getPausedMessage(structuredCode: StructuredCode[], pausedState: PausedState): ChatCompletionUserMessageParam {
  return {
    role: 'user',
    content: [
      'Code:',
